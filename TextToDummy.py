...
field = ['Group']
data = []
with open('denver.csv', encoding='utf-8', newline='\n') as csvfile:
    reader = csv.DictReader(csvfile)
    for review in reader:
        review_detail = {}
        review_detail['Group'] = review['gender'] + review['age']
        ...
        for i in words:
            if i in ['housekeeping', 'professional', 'friendliness', 'staff', 'friendly', 'helpful', 'manager',
                ...
                i = 'room'
                       ...
                       'mattress', 'comfy', 'sleep', 'sleeping', 'zoo']:
                i = 'bed'
...
with open('denver_dummy.csv', 'w', encoding='utf-8', newline='\n') as csvfile:
